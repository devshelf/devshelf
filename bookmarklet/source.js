    ...
    w.DS = w.DS || {};
		...
		/*  Run btoa() with next string in param for base64 encode
    		...
    		<div class = 'ds-helper_cnt'> \
                ...
                <div class='ds-helper_ac_cnt'><label class='ds-label'><input class='ds-radio' type='radio' name='field' id='description' />&nbsp;Choose description by click (opt):</label>  <input type='text' class='ds-helper_description ds-input' name='description' /></div> \
            ...
            w.addEventListener("click", function(e) {
                ...
                if (w.DS.listener) {
					...
					if (d.getElementById("title").checked) {
						...
						d.getElementById("description").checked = true;
